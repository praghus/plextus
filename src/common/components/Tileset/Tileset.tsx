...
import { BG_IMAGE_DARK, RIGHT_BAR_WIDTH, SCALE_STEP } from "../../constants";
...
const Tileset = ({ tilesetCanvas }: Props): JSX.Element => {
  ...
  const onChangeSelectedTile = (tileId: number) =>
    dispatch(changeSelectedTile(tileId));
  ...
  return (
    <>
      <Typography gutterBottom>Tileset</Typography>
        ...
        >
          ...
          >
            <Layer imageSmoothingEnabled={false}>
              ...
              />
              {tilesetCanvas && (
                <Image image={tilesetCanvas} {...{ onMouseDown }} />
              )}
              {/* <GridLines
                dash={false}
                width={imageDimensions.w}
